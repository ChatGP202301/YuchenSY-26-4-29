"""HTML page templates for Yuchen Water multi-language B2B website.
...
{{
  ...
  "name": "Yuchen Water",
  "alternateName": "Yuchen Water China",
  "url": "{canonical}",
...
<header class="header">
  <div class="container header-row">
    <a href="index.html" class="brand">
      <img src="../assets/logo.png" alt="Yuchen Water" class="logo-img" onerror="this.style.display='none'" />
...
<footer class="footer">
  <div class="container footer-grid">
    <div class="footer-col footer-brand">
      <div class="footer-logo">Yuchen Water</div>
  ...
  <div class="footer-bottom">
    <div class="container">
      © 2026 Yuchen Water · {t.get("footer_rights", "All Rights Reserved")} · NSF/ANSI options · ISO 9001 · CE · SGS · Halal documents on request
    </div>
  </div>
</footer>
