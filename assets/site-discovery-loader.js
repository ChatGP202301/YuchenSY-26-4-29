...
(function(){
  ...
  style.rel='stylesheet'; style.href=new URL('site-discovery.css?v=c33ce6bd13fded43',base).href;
  style.dataset.yuchenDiscovery='style';
  style.onload=function(){var script=document.createElement('script');
    script.src=new URL('site-discovery.js?v=c33ce6bd13fded43',base).href;
