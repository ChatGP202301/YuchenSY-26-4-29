...
(function(){
  ...
  style.rel='stylesheet'; style.href=new URL('site-discovery.css?v=1cdfb84dcfa8b92d',base).href;
  style.dataset.yuchenDiscovery='style';
  style.onload=function(){var script=document.createElement('script');
    script.src=new URL('site-discovery.js?v=1cdfb84dcfa8b92d',base).href;
