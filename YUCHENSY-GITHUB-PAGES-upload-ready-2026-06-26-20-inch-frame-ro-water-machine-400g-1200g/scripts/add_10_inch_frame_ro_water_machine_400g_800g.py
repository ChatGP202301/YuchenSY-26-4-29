#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Add 10-inch frame RO water machine 400G-800G across language pages."""
...
NEW_SLUG = "product-10-inch-frame-ro-water-machine-400g-800g.html"
PRODUCT_ID = "10-inch-frame-ro-water-machine-400g-800g"
MAIN_IMAGE = "10-inch-frame-ro-water-machine-400g-800g-oem.webp"
IMAGE_WIDTH = 386
IMAGE_HEIGHT = 492
AFTER_SLUG = "product-thickened-stainless-steel-10-inch-frame-ro-water-machine-400g-800g.html"
TODAY = "2026-06-26"
BRAND = "Yuchen Water"
...
def update_products_json() -> None:
    ...
    entry = {
        ...
        "summary": copy["intro"],
        "features": [
            "400G-800G 10-inch frame RO water machine for municipal tap water",
            ...
            "Open frame structure for commercial drinking water and distributor projects",
    ...
    for index, item in enumerate(products):
        ...
        insert_at = next(
            (
                ...
                if item.get("id") == "thickened-stainless-steel-10-inch-frame-ro-water-machine-400g-800g"
            ),
            10,
        )
...
def update_ai_files() -> None:
    line = f"- 10-Inch Frame RO Water Machine 400G-800G: https://www.yuchensy.com/en/{NEW_SLUG}\n"
